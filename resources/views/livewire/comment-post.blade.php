        ...
        <ul class="divide-y space-y-2">
            ...
            <li class="flex items-start py-4">
                ...
                <div class="ml-4 flex-1">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            @if ($comment->author->isModerator())
                                <span class="text-red-600 text-sm font-semibold">moderator</span>
                            @endif
                        ...
                        <div x-data="{ open: false }" class="relative inline-block">
                            ...
                            <div class="bg-white ring-1 ring-black ring-opacity-5 rounded divide-y divide-gray-100">
                                ...
                                @if (auth()->check() AND auth()->user()->isModerator() OR auth()->id() == $comment->user_id)
                                <div class="space-y-1">
                    ...
                    @if ($comment->spam_reports > 0 AND auth()->check() AND auth()->user()->isModerator())
            ...
            @empty
            <li>
                <div class="py-6 text-sm">Belum ada komentar, jadi yang pertama berkomentar</div>
            </li>
            @endforelse
        </ul>
