<div>
    <div class="text-sm md:items-center text-slate-600 md:flex md:justify-between">
        <div class="flex items-center gap-6 py-6">
            ...
            <div class="hover:text-slate-700 font-semibold text-slate-900">Stories</div>
            <a href="{{ route('user.comments', $user->username) }}" class="hover:text-slate-700">Comments</a>
        </div>
    </div>
        ...
        <ul class="space-y-12">
            ...
            <li class="flex gap-6">
                ...
                <div class="space-y-1 flex-1">
                    ...
                    @if ($post->spam_reports > 0 AND auth()->check() AND auth()->user()->isModerator())
